    ...
    return (
        <div className="py-32">
            <div className="flex flex-col justify-center items-center gap-2 px-4">
                <h1 className="text-heading2Xl">Dataset Object Creation</h1>
                <div className="flex flex-row gap-2 w-full mb-20">
                    <div className="flex flex-col">
                        <h3 className="font-semibold">Dataset Object Name</h3>
                        <input
                    ...
                    <div className="flex flex-col">
                        <h3 className="font-semibold">Object Download</h3>
                        <input
                            className="border-1 border-gray-300 rounded-[4px] h-[36px] px-2 text-bodyMd"
                ...
                <div className="flex flex-row gap-6">
                    <div className="flex flex-col max-w-[400px] gap-4">
                        ...
                        <div className="flex flex-col">
                            <h3 className="font-semibold">Github Repository URL</h3>
                            <input
                                className="border-1 border-gray-300 rounded-[4px] h-[36px] px-2 text-bodyMd"
                        ...
                        <div className="flex flex-col">
                            <h3 className="font-semibold">Github Repository Commit Id</h3>
                            <input
                                className="border-1 border-gray-300 rounded-[4px] h-[36px] px-2 text-bodyMd"
                                ...
                                onChange={e =>
                                    setDataset({
                                        ...
                                        info: {
                                            ...
                                            other: {
                                                ...dataset.info.other,
                                                pipeline: { ...dataset.info.other.pipeline, commit_id: e.target.value }
                                            }
                                        }
                                    })
                                }
                        ...
                        <div className="flex flex-col gap-3">
                            <h3 className="font-semibold">Additional Repositories (Optional)</h3>
                        ...
                        <div className="flex flex-col rounded-b-lg">
                            <h3 className="font-semibold">Usage Policy</h3>
                            <Editor
                                pt={{
                                    root: {
                                        className: 'bg-white'
