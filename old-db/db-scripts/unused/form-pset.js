const dataset = [
    ...
    {
        label: 'BeatAML', name: 'BeatAML', 
        versions: [
            {
                version: '2018', pipeline: '', label: '2018(BeatAML)', type: 'sensitivity',
                publication: [
...
const form = {
    ...
    dataset: dataset.sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase())),
